...
<p>This website serves as my personal portfolio, showcasing my projects, skills, and experience in web development. It was built using <strong>ASP.NET WebForms</strong>, 
    with styling implemented through <strong>CSS</strong> and additional interactivity provided by <strong>JavaScript</strong>.</p>

<h3>Purpose</h3>
<p>The main purpose of this portfolio is to provide a centralized platform for presenting my technical expertise, 
    sharing my completed projects, and offering an accessible way for others to learn more about my work and accomplishments. E
    ach project is accompanied by its source code, which is hosted on my <a href="https://github.com/ArielBaron" target="_blank">GitHub repositories</a>. 
    You can find links to the corresponding repositories in the respective tabs of the site.</p>
...
<h3>Conclusion</h3>
<p>This portfolio website not only serves as a professional showcase of my work but also reflects my proficiency in using WebForms, CSS, JavaScript, and ASP.NET.
    By linking each project to its respective GitHub repository, I aim to maintain transparency and encourage others to explore my code in detail.</p>
