...
<asp:Content ID="Content2" ContentPlaceHolderID="pageContent" runat="server">
    ...
    <p>
        This project is a website using <a target="_blank" href="https://npm.io/package/mashov-api">mashov api</a>
    ...
    <h1>I Now Have a Website it's Currently is only open by request to me (visit the <a href="Contact.aspx">Contact page</a>for more info)</h1>
    ...
    <div class="img-album">
        <img src="./Assets/mashov1.png" class="img-item" alt="Alternate Text" />
        <img src="./Assets/mashov2.png" class="img-item" alt="Alternate Text" />
        <img src="./Assets/mashov3.png" class="img-item" alt="Alternate Text" />
   </div>
