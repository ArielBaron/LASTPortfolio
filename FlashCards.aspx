...
<asp:Content ID="Content2" ContentPlaceHolderID="pageContent" runat="server">
    <div>
        ...
        <p>The "Train for Test using Flashcards" project provides a platform where users can create, edit,
            and use flashcards to enhance their learning and retention. It is implemented using HTML, JavaScript, and CSS to provide a responsive and interactive interface.</p>
        ...
        <ol>
            <li>Visit the GitHub repository, clone and run index.html: 
                <a href="https://github.com/ArielBaron/Train-for-Test-using-traning-cards" target="_blank">Train for Test using Flashcards</a>.</li>
