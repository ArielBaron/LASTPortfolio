...
<asp:Content ID="Content2" ContentPlaceHolderID="pageContent" runat="server">
    <div>
        ...
        <h2>How It Works</h2>
        <p>The game board consists of 9 squares represented as a list.
            Players take turns selecting squares to place their mark (X or O).
            The game ends when a player aligns three of their marks in a row, column, or diagonal, or when all squares are filled without a winner (draw).</p>
